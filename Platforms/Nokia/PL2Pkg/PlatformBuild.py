# @file
# Script to Build Mi Max 3 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("PL2Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('PL2', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "PL2Pkg/PL2.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "PL2", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "PL2Pkg/PL2.dsc", "Platform Hardcoded")
